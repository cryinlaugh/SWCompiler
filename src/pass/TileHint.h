...
class TileHint {
  ...
  public:
    ...
    // std::vector<std::vector <unsigned long>> computeSpilts (TensorShape*
    // shape, std::vector<unsigned long > tilehintStep ){
    ...
    //   std::vector<TensorShape>* computeSlices(TensorShape * shape,
    //   std::vector<unsigned long > tilehintStep){

    //       std::vector<TensorShape> * slices;
    //       std::vector<std::vector<unsigned long >> shapeSpilts =
    //       computeSpilts(shape, tilehintStep);
