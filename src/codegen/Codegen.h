...
public:
    ...
    void emitTensorInitializations(IRGraph* graph_, std::set<Tensor*>* visited);
    ...
    void emitMemcpyFromTo(Tensor* from, Device from_dev, size_t offset, size_t size,
...
private:
    ...
    std::unordered_map<Tensor*, std::pair<std::string, uint64_t>> tensors_offset_map_;
