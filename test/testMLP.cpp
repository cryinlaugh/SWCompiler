...
int main() {
    ...
    // --init TensorShape:
    TensorShape*   dataTensorShape_0 = new TensorShape(new vector<unsigned long>({1000,1000}));
    ...
    TensorShape*       weightTensorShape_0 = new TensorShape(new vector<unsigned long>({1000,1000}));
    ...
    TensorShape*       dataTensorShape_1 = new TensorShape(new vector<unsigned long>({1000,1000}));
    ...
    TensorShape*       dataTensorShape_2 = new TensorShape(new vector<unsigned long>({1000,1000}));
