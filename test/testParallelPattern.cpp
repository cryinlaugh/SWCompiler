...
int main() {
    ...
    fc0->setLabel(new StrategyLabel({0, -1, -1, 0}));
    tanh0->setLabel(new StrategyLabel({0, 0}));
    fc1->setLabel(new StrategyLabel({0, -1, -1, 0}));
    softmax0->setLabel(new StrategyLabel({1, 1}));
