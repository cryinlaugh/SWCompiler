...
int main()
{
    ...
    DYOP(conv1_1_o, Conv2dOp, conv1_1_kernels, conv1_1_strides, conv1_1_pads);
    LINKUPPER(conv1_1_o, data, conv1_1_w, conv1_1_b);
    TENSOR(conv1_1, 0);
    LINKUPPER(conv1_1, conv1_1_o);

    OP(relu1_1_o, ReluOp);
    LINKUPPER(relu1_1_o, conv1_1);
    TENSOR(relu1_1, 0);
    LINKUPPER(relu1_1, relu1_1_o);
    ...
    DYOP(conv1_2_o, Conv2dOp, conv1_2_kernels, conv1_2_strides, conv1_2_pads);
    LINKUPPER(conv1_2_o, relu1_1, conv1_2_w, conv1_2_b);
    TENSOR(conv1_2, 0);
    LINKUPPER(conv1_2, conv1_2_o);

    OP(relu1_2_o, ReluOp);
    LINKUPPER(relu1_2_o, conv1_2);
    TENSOR(relu1_2, 0);
    LINKUPPER(relu1_2, relu1_2_o);
    ...
    DYOP(conv2_1_o, Conv2dOp, conv2_1_kernels, conv2_1_strides, conv2_1_pads);
    LINKUPPER(conv2_1_o, pool1, conv2_1_w, conv2_1_b);
    TENSOR(conv2_1, 0);
    LINKUPPER(conv2_1, conv2_1_o);

    OP(relu2_1_o, ReluOp);
    LINKUPPER(relu2_1_o, conv2_1);
    TENSOR(relu2_1, 0);
    LINKUPPER(relu2_1, relu2_1_o);
    ...
    DYOP(conv2_2_o, Conv2dOp, conv2_2_kernels, conv2_2_strides, conv2_2_pads);
    LINKUPPER(conv2_2_o, relu2_1, conv2_2_w, conv2_2_b);
    TENSOR(conv2_2, 0);
    LINKUPPER(conv2_2, conv2_2_o);

    OP(relu2_2_o, ReluOp);
    LINKUPPER(relu2_2_o, conv2_2);
    TENSOR(relu2_2, 0);
    LINKUPPER(relu2_2, relu2_2_o);
    ...
    DYOP(conv3_1_o, Conv2dOp, conv3_1_kernels, conv3_1_strides, conv3_1_pads);
    LINKUPPER(conv3_1_o, pool2, conv3_1_w, conv3_1_b);
    TENSOR(conv3_1, 0);
    LINKUPPER(conv3_1, conv3_1_o);

    OP(relu3_1_o, ReluOp);
    LINKUPPER(relu3_1_o, conv3_1);
    TENSOR(relu3_1, 0);
    ...
    DYOP(conv3_2_o, Conv2dOp, conv3_2_kernels, conv3_2_strides, conv3_2_pads);
    LINKUPPER(conv3_2_o, relu3_1, conv3_2_w, conv3_2_b);
    TENSOR(conv3_2, 0);
    LINKUPPER(conv3_2, conv3_2_o);

    OP(relu3_2_o, ReluOp);
    LINKUPPER(relu3_2_o, conv3_2);
    TENSOR(relu3_2, 0);
    LINKUPPER(relu3_2, relu3_2_o);
    ...
    DYOP(conv3_3_o, Conv2dOp, conv3_3_kernels, conv3_3_strides, conv3_3_pads);
    LINKUPPER(conv3_3_o, relu3_2, conv3_3_w, conv3_3_b);
    TENSOR(conv3_3, 0);
    LINKUPPER(conv3_3, conv3_3_o);

    OP(relu3_3_o, ReluOp);
    LINKUPPER(relu3_3_o, conv3_3);
    TENSOR(relu3_3, 0);
    LINKUPPER(relu3_3, relu3_3_o);
    ...
    DYOP(conv3_4_o, Conv2dOp, conv3_4_kernels, conv3_4_strides, conv3_4_pads);
    LINKUPPER(conv3_4_o, relu3_3, conv3_4_w, conv3_4_b);
    TENSOR(conv3_4, 0);
    LINKUPPER(conv3_4, conv3_4_o);

    OP(relu3_4_o, ReluOp);
    LINKUPPER(relu3_4_o, conv3_4);
    TENSOR(relu3_4, 0);
    LINKUPPER(relu3_4, relu3_4_o);
    ...
    DYOP(conv4_1_o, Conv2dOp, conv4_1_kernels, conv4_1_strides, conv4_1_pads);
    LINKUPPER(conv4_1_o, pool3, conv4_1_w, conv4_1_b);
    TENSOR(conv4_1, 0);
    LINKUPPER(conv4_1, conv4_1_o);

    OP(relu4_1_o, ReluOp);
    LINKUPPER(relu4_1_o, conv4_1);
    TENSOR(relu4_1, 0);
    ...
    DYOP(conv4_2_o, Conv2dOp, conv4_2_kernels, conv4_2_strides, conv4_2_pads);
    LINKUPPER(conv4_2_o, relu4_1, conv4_2_w, conv4_2_b);
    TENSOR(conv4_2, 0);
    LINKUPPER(conv4_2, conv4_2_o);

    OP(relu4_2_o, ReluOp);
    LINKUPPER(relu4_2_o, conv4_2);
    TENSOR(relu4_2, 0);
    ...
    DYOP(conv4_3_o, Conv2dOp, conv4_3_kernels, conv4_3_strides, conv4_3_pads);
    LINKUPPER(conv4_3_o, relu4_2, conv4_3_w, conv4_3_b);
    TENSOR(conv4_3, 0);
    LINKUPPER(conv4_3, conv4_3_o);

    OP(relu4_3_o, ReluOp);
    LINKUPPER(relu4_3_o, conv4_3);
    TENSOR(relu4_3, 0);
    LINKUPPER(relu4_3, relu4_3_o);
    ...
    DYOP(conv4_4_o, Conv2dOp, conv4_4_kernels, conv4_4_strides, conv4_4_pads);
    LINKUPPER(conv4_4_o, relu4_3, conv4_4_w, conv4_4_b);
    TENSOR(conv4_4, 0);
    LINKUPPER(conv4_4, conv4_4_o);

    OP(relu4_4_o, ReluOp);
    LINKUPPER(relu4_4_o, conv4_4);
    TENSOR(relu4_4, 0);
    LINKUPPER(relu4_4, relu4_4_o);
    ...
    DYOP(conv5_1_o, Conv2dOp, conv5_1_kernels, conv5_1_strides, conv5_1_pads);
    LINKUPPER(conv5_1_o, pool4, conv5_1_w, conv5_1_b);
    TENSOR(conv5_1, 0);
    LINKUPPER(conv5_1, conv5_1_o);

    OP(relu5_1_o, ReluOp);
    LINKUPPER(relu5_1_o, conv5_1);
    TENSOR(relu5_1, 0);
    ...
    DYOP(conv5_2_o, Conv2dOp, conv5_2_kernels, conv5_2_strides, conv5_2_pads);
    LINKUPPER(conv5_2_o, relu5_1, conv5_2_w, conv5_2_b);
    TENSOR(conv5_2, 0);
    LINKUPPER(conv5_2, conv5_2_o);

    OP(relu5_2_o, ReluOp);
    LINKUPPER(relu5_2_o, conv5_2);
    TENSOR(relu5_2, 0);
    LINKUPPER(relu5_2, relu5_2_o);
    ...
    DYOP(conv5_3_o, Conv2dOp, conv5_3_kernels, conv5_3_strides, conv5_3_pads);
    LINKUPPER(conv5_3_o, relu5_2, conv5_3_w, conv5_3_b);
    TENSOR(conv5_3, 0);
    LINKUPPER(conv5_3, conv5_3_o);

    OP(relu5_3_o, ReluOp);
    LINKUPPER(relu5_3_o, conv5_3);
    TENSOR(relu5_3, 0);
    LINKUPPER(relu5_3, relu5_3_o);
    ...
    DYOP(conv5_4_o, Conv2dOp, conv5_4_kernels, conv5_4_strides, conv5_4_pads);
    LINKUPPER(conv5_4_o, relu5_3, conv5_4_w, conv5_4_b);
    TENSOR(conv5_4, 0);
    LINKUPPER(conv5_4, conv5_4_o);

    OP(relu5_4_o, ReluOp);
    LINKUPPER(relu5_4_o, conv5_4);
    TENSOR(relu5_4, 0);
    LINKUPPER(relu5_4, relu5_4_o);
    ...
    GpT(vgg19,
            ...
            pool5,
            fc6, fc6_w, fc6_b, relu6, dropout6,
            fc7, fc7_w, fc7_b, relu7, dropout7,
            fc8, fc8_w, fc8_b,
    		label, prob, loss);
    GpO(vgg19,
            conv1_1_o, relu1_1_o,
