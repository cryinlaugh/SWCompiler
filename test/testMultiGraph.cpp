...
//-----------GPU0-------------------------------------
    TensorNode<Dtype>* data0_rep0 = new TensorNode<Dtype>("data0");
    data0_rep0->setTensor(data0->getTensor());
    TensorNode<Dtype>* weight0_rep0 = new TensorNode<Dtype>("weight0");
    ...
    TensorNode<Dtype>* data2_rep0 = new TensorNode<Dtype>("data2");
    data2_rep0->setTensor(data2->getTensor());
    LINKUPPER(data2_rep0, gather0);

    IRGraph<Dtype>* subGraph0 = new IRGraph<Dtype>();
    subGraph0->pushTensorNode(data0_rep0, weight0_rep0,
        data0_gpu0, weight0_gpu0,
        data1_gpu0, data2_gpu0,
        data2_rep0);
    subGraph0->pushOpNode(scatter00, scatter01,
        matmul0_gpu0,
        tanh0_gpu0,
        gather0);
...
//-----------GPU1-------------------------------------
    TensorNode<Dtype>* data0_rep1 = new TensorNode<Dtype>("data0");
    data0_rep1->setTensor(data0->getTensor());
    TensorNode<Dtype>* weight0_rep1 = new TensorNode<Dtype>("weight0");
    ...
    TensorNode<Dtype>* data2_rep1 = new TensorNode<Dtype>("data2");
    data2_rep1->setTensor(data2->getTensor());
    LINKUPPER(data2_rep1, gather1);

    IRGraph<Dtype>* subGraph1 = new IRGraph<Dtype>();
    subGraph1->pushTensorNode(data0_rep1, weight0_rep1,
        data0_gpu1, weight0_gpu1,
        data1_gpu1, data2_gpu1,
        data2_rep1);
    subGraph1->pushOpNode(scatter10, scatter11,
        matmul0_gpu1,
        tanh0_gpu1,
        gather1);
    ...
    MLPLayer->pushTensorNode(data0, weight0,
        data2, data3);
    ...
    subGraph1->updateTopoNodeList();
    Optimizer<Dtype>* opt = new Optimizer<Dtype>(subGraph1);
    opt->runOptimizer();
    dotGen(subGraph1);

    subGraph0->updateTopoNodeList();
